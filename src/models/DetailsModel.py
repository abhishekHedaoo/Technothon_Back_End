class DetailsModel:
  def __init__(self,ward_no,no_trees,population,co2_absorbtion,co2_emitted_population,co2_emitted_vehicles,co2_emitted_total,accessed_co2,tree_required):
    ...
    self.accessed_co2 = accessed_co2
  ...
  def toJSON(self):
    return {
      ...
      "accessed_co2": str(self.accessed_co2),
